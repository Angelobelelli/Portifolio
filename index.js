...
function toggleGitHubIconColor() {
  ...
  if (body.classList.contains('dark')) {
    ...
    githubIcon.style.color = '#000'; // Alterando a cor do ícone para branco no Modo Dark
    bxllinkedin.style.color = '#000'; // Alterando a cor do ícone para branco no Modo Dark
    bxlinstagram.style.color = '#000'; // Alterando a cor do ícone para branco no Modo Dark
  }
}

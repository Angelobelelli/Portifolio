...
const socialLinks: SocialLink[] = [
    {
        ...
        icon: Linkedin,
        url: "https://linkedin.com/in/angelobelelli",
        color: "#0A66C2",
    ...
    },
    {
        name: "GitHub",
        displayName: "GitHub",
        subText: "Angelobelelli",
        icon: Github,
        url: "https://github.com/Angelobelelli",
        color: "#ffffff",
...
const SocialLinks = () => {
    ...
    const [whatsapp, github] = otherLinks;

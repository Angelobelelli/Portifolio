...
const HeroSection = () => {
    ...
    const dados = {
        welcomeTexts: ["Angelo", "Belelli"],
        titleTexts: [ "Full Stack Developer"],
        icons: [Mail, Linkedin, Github],
        hrefs: [
            "mailto:angelobelelli.dev@gamil.com",
            "https://www.linkedin.com/in/angelobelelli/",
            "https://github.com/Angelobelelli"
        ]
    };

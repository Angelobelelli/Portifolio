        ...
        () => [
            {
                ...
                label: "Paixão",
                description:
                    "Gerar valor por meio da tecnologia, explorando ideias, lendo livros, fazendo pesquisas e criando interfaces que conectam e inspiram.",
            ...
            },
            {
                ...
                label: "Metodologia",
                description:
                    "Pratico desenvolvimento ágil com foco em entregas eficientes, priorizando código limpo e de fácil manutenção.",
                animation: "fade-up",
            },
            {
                icon: Globe,
        ...
        >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]">
              ...
              Angelo Belelli
                    ...
                    >
                        Sou desenvolvedor Full Stack com experiência prática em Node.js,
                        React, TypeScript, MySQL e TailwindCSS, atuando em projetos que
                        envolvem desde a modelagem de dados até a entrega de interfaces modernas e responsivas.
                        Tenho como foco a construção de APIs escaláveis,
                        seguras e bem estruturadas, aplicando boas práticas como JWT,
                        controle de roles, clean code e organização modular.
                    </p>
                    ...
                    >
                        ...
                        <blockquote className="text-gray-300 italic font-medium text-sm relative z-10 pl-6">
                            &ldquo;Aproveitando a IA como uma ferramenta profissional, não
                            como um substituto.&rdquo;
                        </blockquote>
                    </div>
